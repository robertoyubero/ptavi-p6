...
class EchoHandler(socketserver.DatagramRequestHandler):
    ...
    def envio_RTP(self):
        ...
        """
        # envio RTP
        paquete_RTP = ('./mp32rtp -i ' + IP_DESTINO + ' -p ' + PUERTO_DESTINO + ' < '
        + FICHERO)
        print("Enviando paquete RTP...")
        os.system(paquete_RTP)
        return ("Finalizado envio de paquetes RTP...")
    ...
    def handle(self):
        while 1:
            ...
            if peticion_cliente == 'INVITE':
                ...
                #self.tratar_bye()
                print('DEBO GESTIONAR: BYE')
                respuesta = 'DEBO GESTIONAR: BYE'
...
if __name__ == "__main__":
    ...
    serv = socketserver.UDPServer((IP_DESTINO, int(PUERTO_DESTINO)), EchoHandler)
    print("Listening...\n")
    serv.serve_forever()
